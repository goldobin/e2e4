...
Piece      Squares_At(const Squares s, Pos pos);
void       Squares_UpdateAt(Squares s, Pos pos, Piece p);
...
void       Threats_Append(Threats* ts, Threat t);
void       Threats_Collect(Threats* dst, const Board* b, Pos p);
